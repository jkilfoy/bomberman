...
import { Rectangle, rectsIntersect } from "../collision/Rectangle";
 ...
 */
export function getNearestNonintersectingPosition(r1: Rectangle, r2: Rectangle, direction: Direction): WorldCoordinate {
